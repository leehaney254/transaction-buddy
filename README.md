...
# 📖 Transaction Buddy <a name="about-project"></a>

**Transaction Buddy** is an application that One can create categories for all their transaction, view total cost of all categories, view the cost of one transaction.
...
- Clone the project to your directory by running
  - `https://github.com/leehaney254/transaction-buddy.git`
- Run `Bundle install`
- Run `npm install`
